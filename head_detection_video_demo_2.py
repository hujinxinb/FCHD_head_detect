...
def findPeopleNumHead(video_address, video_duration_time):
    frame_interval=5
    ...
    while ret:
        ...
        if (c % timeF == 0):
            ...
            thispic_count_result = detect(img_path, model_path)
    ...
    return [c/int(vs.get(cv2.CAP_PROP_FPS)), find_people_num]
